...
# -*- coding: utf-8 -*-
"""
Design intelligence search - BM25 search engine for UI/UX style guides
...
def format_output(result, full=False):
    ...
    output = []
    if result.get("stack"):
        output.append("## Design Intelligence Stack Guidelines")
        output.append(f"**Stack:** {result['stack']} | **Query:** {result['query']}")
    else:
        output.append("## Design Intelligence Search Results")

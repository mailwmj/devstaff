...
rounded:
  none: 0px
method-rules:
  grid: "8px or 16px pixel grid"
  alignment: "icon-first — must read at 16x16/32x32 before scaling up"
  decoration: "flat pixel shapes only, no gradients or 3D shadow"
  max-typefaces: 2
  signature-move: "pixel-icon-clarity"
---

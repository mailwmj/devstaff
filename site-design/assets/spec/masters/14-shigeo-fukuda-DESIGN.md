...
rounded:
  none: 0px
method-rules:
  grid: "white background, single centered figure, minimal text"
  alignment: "centered"
  decoration: "none — the visual paradox itself is the only decoration"
  max-typefaces: 2
  signature-move: "visual-paradox-single-image"
---

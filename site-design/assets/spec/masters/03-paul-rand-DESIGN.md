...
rounded:
  none: 0px
method-rules:
  grid: "generous whitespace around one dominant symbol, no dense grid"
  alignment: "asymmetric but with a stable visual anchor"
  decoration: "minimal — one strong geometric symbol, no decorative clutter"
  max-typefaces: 2
  signature-move: "single-symbol-concept"
---

...
rounded:
  none: 0px
method-rules:
  grid: "8-col or 12-col grid with generous margins and clear breathing room"
  alignment: "left-aligned, stable and regular module rhythm"
  decoration: "none — no large gradients, glassmorphism, or complex illustration"
  max-typefaces: 2
  signature-move: "every-element-has-a-function"
---

...
rounded:
  none: 0px
method-rules:
  grid: "12-col or 6-col strict grid, or a clear center axis"
  alignment: "left-aligned primary; strict axis required if centered"
  decoration: "none"
  max-typefaces: 2
  signature-move: "grid-first-layout"
---

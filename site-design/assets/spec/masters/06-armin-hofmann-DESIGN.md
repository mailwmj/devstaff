...
rounded:
  none: 0px
method-rules:
  grid: "no fixed column count — tension built from scale contrast"
  alignment: "asymmetric, shape-driven"
  decoration: "black-and-white forms only, near-zero color"
  max-typefaces: 2
  signature-move: "black-white-tension-before-color"
---

...
rounded:
  none: 0px
method-rules:
  grid: "layered transparent planes on a mechanical axis"
  alignment: "diagonal or layered, but must keep one reading path"
  decoration: "transparent overlays, geometric shapes, light-and-shadow collage"
  max-typefaces: 3
  signature-move: "photo-geometry-collage"
---
